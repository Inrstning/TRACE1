...
class TraceScorer(RelationalScorer):
    r"""Implementation of the Trace KGE scorer."""
    ...
    def score_emb(self, s_emb, p_emb, o_emb, t_emb, combine: str, s, o, gt_ent=None, gt_rel=None, gt_tim=None, t_ids=None):
        ...
        if combine == 'spoo' or combine == 'sp_' or combine == 'spo':
            ...
            raise Exception("Combine {} is not supported in Trace's score function".format(combine))
        return out


class Trace(KgeModel):
    r"""Implementation of the Trace KGE model."""

    def __init__(self, config: Config, dataset: Dataset, configuration_key=None):
        super().__init__(
            config, dataset, TraceScorer, configuration_key=configuration_key
        )
    ...
    def score_spo(self, s: Tensor, p: Tensor, o: Tensor, t: Tensor, direction=None) -> Tensor:
        ...
        if direction:
            ...
            raise Exception(
                "The Trace model cannot compute "
